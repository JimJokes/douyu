...
class SysTrayIcon(object):
    ...
    def __init__(self,
        ...
        self.menu_actions_by_id = dict(self.menu_actions)
        del self._next_action_id, self.menu_actions
    ...
    def _add_ids_to_menu_options(self, menu_options):
        ...
        for menu_option in menu_options:
            ...
            if callable(option_action) or option_action in self.SPECIAL_ACTIONS:
                self.menu_actions.add((self._next_action_id, option_action))
    ...
    def create_menu(self, menu, menu_options):
        for option_text, option_icon, option_action, option_id in menu_options[::-1]:
            ...
            if option_id in self.menu_actions_by_id.keys():
...
if __name__ == '__main__':
    ...
    def open_browser(sysTrayIcon): webbrowser.open('www.baidu.com')
